...
export default Component.extend(ClusterDriver, {
  intl:        service(),
  layout,
  configField: 'huaweiContainerCloudEngineConfig',
  zones:       [{
    label: 'cn-north-1',
    value: 'cn-north-1',
  }],
  ...
  init() {
    ...
    let config = get(this, 'cluster.huaweiContainerCloudEngineConfig');

    if ( !config ) {
      config = this.get('globalStore').createRecord({
        type:                  'huaweiContainerCloudEngineConfig',
        accessKey:             null,
        secretKey:             null,
        zone:                  'cn-north-1',
      ...
      set(this, 'cluster.huaweiContainerCloudEngineConfig', config);
  ...
  validate() {
    ...
    if (!get(this, 'config.authenticatingProxyCa') && get(this, 'config.authentiactionMode') === 'authenticating_proxy') {
