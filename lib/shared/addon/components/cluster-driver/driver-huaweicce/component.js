...
export default Component.extend(ClusterDriver, {
  ...
  eipIdContent: computed('eipIds.[]', function() {
    ...
    let res = eipIds.filter(e => e.status === 'DOWN').map(e => ({label: e.public_ip_address, value: e.id}))
    console.log(res, 'eipIdContent')
  ...
  passwordChange: observer('preBase64Password', function() {
    ...
    if (preBase64Password.length < 8 || preBase64Password.length > 26) {
