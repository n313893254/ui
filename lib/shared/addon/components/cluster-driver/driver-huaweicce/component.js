...
export default Component.extend(ClusterDriver, {
  ...
  init() {
    ...
    window.cryptoX = crypto
    // V6azyeLwcD3CHlpY
    // console.log(this.crypt(SHA512("V6azyeLwcD3CHlpY").toString(), 'Cloud.1234'))
    // let hash = Crypt("password", "sa");
    // let homura = crypto.TripleDES.encrypt(SHA512("Cloud.1234"), 'V6azyeLwcD3CHlpY').toString()
    let decode = crypto.TripleDES.decrypt('BN3VVq18fmCkj66B4zdHLWevqcxlig/GpOkLcOhab9smJoLKYm/Tf9Hcwa6DpiPDhdHfGEAPajFmLZa0YDd910', 'V6azyeLwcD3CHlpY').toString()
    console.log(decode, 'decode')
    // console.log(SHA512("V6azyeLwcD3CHlpYCloud.1234").toString())
  ...
  willSave() {
    ...
    if (get(this, 'mode') === 'new') {
      ...
      // const hikari = crypto.TripleDES.encrypt(crypto.SHA512(preBase64Password).toString(crypto.enc.Base64), 'V6azyeLwcD3CHlpY').toString()
      // const homura = `$6$V6azyeLwcD3CHlpY$` + hikari
