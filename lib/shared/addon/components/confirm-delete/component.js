...
export default Component.extend(ModalBase, {
  ...
  init() {
    ...
    const resources = get(this, 'resources') || []
    const filter = resources.filter(r => r.type === 'app')
    if (filter.length > 0) {
      set(this, 'canDeleteNamespace', true)
    }
  },
