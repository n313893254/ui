...
const DEFAULT_INSTANCE_TYPE = 'ecs.sn1ne.large';
const DEFAULT_IMAGE_NAME = 'Ubuntu  18.04 64 bit';
    ...
    loadInstanceTypes(cb) {
      this.fetch('Image', 'Images')
        .then((images) => {
          ...
          if (!found ) {
            set(this, 'config.imageId', (get(this, 'images').findBy('raw.OSNameEn', DEFAULT_IMAGE_NAME) || get(this, 'images.firstObject')).value);
          }
