...
${str}
  ...
  brokerTypeChange: function() {
    ...
    const keytab = get(this, 'config.keytab');
    const principal = get(this, 'config.principal');
    const certificate = get(this, 'config.certificate');
    const clientCert = get(this, 'config.clientCert');
    const clientKey = get(this, 'config.clientKey');
    const cachedZookeeperEndpoint = get(this, 'cachedZookeeperEndpoint');
    const cachedBrokerEndpoints = get(this, 'cachedBrokerEndpoints');
    const cachedKeytab = get(this, 'cachedKeytab');
    const cachedPrincipal = get(this, 'cachedPrincipal');
    const cachedCertificate = get(this, 'cachedCertificate');
    const cachedClientCert = get(this, 'cachedClientCert');
    const cachedClientKey = get(this, 'cachedClientKey');
    if (t === 'zookeeper') {
      set(this, 'cachedBrokerEndpoints', brokerEndpoints);

      set(this, 'cachedKeytab', keytab);
      set(this, 'cachedPrincipal', principal);

      set(this, 'cachedCertificate', certificate);
      set(this, 'cachedClientCert', clientCert);
      set(this, 'cachedClientKey', clientKey);

      set(this, 'config.zookeeperEndpoint', cachedZookeeperEndpoint);

      set(this, 'brokerEndpoints', null);

      set(this, 'config.keytab', null);
      set(this, 'config.principal', null);

      set(this, 'config.certificate', null);
      set(this, 'config.clientCert', null);
      set(this, 'config.clientKey', null);
    } else if (t === 'broker') {
      ...
      set(this, 'config.keytab', cachedKeytab);
      set(this, 'config.principal', cachedPrincipal);

      set(this, 'config.certificate', cachedCertificate);
      set(this, 'config.clientCert', cachedClientCert);
      set(this, 'config.clientKey', cachedClientKey);
    }
  }.observes('brokerType'),
