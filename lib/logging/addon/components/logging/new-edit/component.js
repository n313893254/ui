...
export default Component.extend(NewOrEdit, {
  ...
  init() {
    ...
    console.log(get(this, 'originalModelTargetType'), 'targetType')
    if (get(this, 'originalModelTargetType') === 'customTarget') {
      set(this, 'pasteOrUpload', true)
      set(this, 'customContent', get(this, 'model.customTargetConfig.content'))
    }
  },
  ...
  willSave() {
    ...
    if (targetType === 'none' && !get(this, 'pasteOrUpload')) {
      return false;
    }
    ...
    if (get(this, 'pasteOrUpload')) {
      ...
      console.log(get(this, 'customContent'), 'customContent')
      const customContent = get(this, 'customContent')
      const myString = customContent.replace(/(\r\n|\n|\r)/gm, "<br />");
      const arr = myString.split('<br />').filter(f => f !== '<br />')
      console.log(arr, 'arr')
      setProperties(model, {
